      ...
      <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          ...
          <nav class="flex gap-6">
            ...
            <a href="./recipes.html" class="text-lg text-stone-700 hover:text-amber-800 transition-colors font-medium">Recipes</a>
            <a href="./about.html" class="text-lg text-stone-700 hover:text-amber-800 transition-colors font-medium">About</a>
          </nav>
        </div>
      </div>
    </header>
